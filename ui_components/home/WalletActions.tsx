...
export default function WalletActions() {
  const actions = [
    { id: 1, name: "Send", icon: icons.sendIcon.src, url: "/" },
    { id: 2, name: "Receive", icon: icons.receiveIcon.src, url: "/" },
    { id: 3, name: "Swap", icon: icons.swapIcon.src, url: "/" },
    { id: 4, name: "Buy", icon: icons.buyIcon.src, url: "buy" },
  ];
  return (
